 ...
 */
public interface TextAreaBindingListener2 {
    /**
     * Text area binding listener adapter.
     */
    public static class Adapter implements TextAreaBindingListener2 {
        @Override
        ...
        @Override
        public void textBindMappingChanged(TextArea2 textArea, TextArea2.TextBindMapping previousTextBindMapping) {
        }
    }
