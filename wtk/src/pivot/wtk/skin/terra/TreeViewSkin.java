...
public class TreeViewSkin extends ComponentSkin implements TreeView.Skin,
    ...
    protected int indent = DEFAULT_INDENT;
    protected boolean showHighlight = DEFAULT_SHOW_HIGHLIGHT;
    protected boolean showBranchControls = DEFAULT_SHOW_BRANCH_CONTROLS;
    protected Color branchControlsColor = DEFAULT_BRANCH_CONTROLS_COLOR;
    protected Color branchControlsDisabledColor = DEFAULT_BRANCH_CONTROLS_DISABLED_COLOR;
    protected Color branchControlsSelectionColor = DEFAULT_BRANCH_CONTROLS_SELECTION_COLOR;
    protected Color branchControlsInactiveSelectionColor = DEFAULT_BRANCH_CONTROLS_INACTIVE_SELECTION_COLOR;
    protected Color gridColor = DEFAULT_GRID_COLOR;
    protected boolean showGridLines = DEFAULT_SHOW_GRID_LINES;
    ...
    private static final Color DEFAULT_SELECTION_BACKGROUND_COLOR = new Color(0x3C, 0x77, 0xB2);
    private static final Color DEFAULT_INACTIVE_SELECTION_COLOR = Color.BLACK;
    private static final Color DEFAULT_INACTIVE_SELECTION_BACKGROUND_COLOR = new Color(0xE6, 0xE3, 0xDA);
    ...
    private static final boolean DEFAULT_SHOW_BRANCH_CONTROLS = true;
    private static final Color DEFAULT_BRANCH_CONTROLS_COLOR = new Color(0x33, 0x66, 0x99);
    private static final Color DEFAULT_BRANCH_CONTROLS_DISABLED_COLOR = new Color(0x3C, 0x77, 0xB2);
    private static final Color DEFAULT_BRANCH_CONTROLS_SELECTION_COLOR = Color.WHITE;
    private static final Color DEFAULT_BRANCH_CONTROLS_INACTIVE_SELECTION_COLOR = new Color(0x33, 0x66, 0x99);
    private static final Color DEFAULT_GRID_COLOR = new Color(0xF7, 0xF5, 0xEB);
    private static final boolean DEFAULT_SHOW_GRID_LINES = false;
    ...
    protected static final String INDENT_KEY = "indent";
    protected static final String SHOW_HIGHLIGHT_KEY = "showHighlight";
    protected static final String SHOW_BRANCH_CONTROLS_KEY = "showBranchControls";
    protected static final String BRANCH_CONTROLS_COLOR_KEY = "branchControlsColor";
    protected static final String BRANCH_CONTROLS_DISABLED_COLOR_KEY = "branchControlsDisabledColor";
    protected static final String BRANCH_CONTROLS_SELECTION_COLOR_KEY = "branchControlsSelectionColor";
    protected static final String BRANCH_CONTROLS_INACTIVE_SELECTION_COLOR_KEY = "branchControlsInactiveSelectionColor";
    protected static final String GRID_COLOR_KEY = "gridColor";
    protected static final String SHOW_GRID_LINES_KEY = "showGridLines";
                        ...
                        if (treeView.isEnabled()
                            ...
                            if (selected) {
                                if (treeView.isFocused()) {
                                    branchControlColor = branchControlsSelectionColor;
                                } else {
                                    branchControlColor = branchControlsInactiveSelectionColor;
                                }
                            } else {
                                branchControlColor = branchControlsColor;
                            }
                        } else {
                            branchControlColor = branchControlsDisabledColor;
                        }
    ...
    public Object get(String key) {
        ...
        if (key.equals(FONT_KEY)) {
            ...
            value = spacing;
        } else if (key.equals(INDENT_KEY)) {
            value = indent;
        } else if (key.equals(SHOW_HIGHLIGHT_KEY)) {
            value = showHighlight;
        } else if (key.equals(SHOW_BRANCH_CONTROLS_KEY)) {
            value = showBranchControls;
        } else if (key.equals(BRANCH_CONTROLS_COLOR_KEY)) {
            value = branchControlsColor;
        } else if (key.equals(BRANCH_CONTROLS_DISABLED_COLOR_KEY)) {
            value = branchControlsDisabledColor;
        } else if (key.equals(BRANCH_CONTROLS_SELECTION_COLOR_KEY)) {
            value = branchControlsSelectionColor;
        } else if (key.equals(BRANCH_CONTROLS_INACTIVE_SELECTION_COLOR_KEY)) {
            value = branchControlsInactiveSelectionColor;
        } else if (key.equals(GRID_COLOR_KEY)) {
            value = gridColor;
        } else if (key.equals(SHOW_GRID_LINES_KEY)) {
            value = showGridLines;
        } else {
            value = super.get(key);
        }
    ...
    public Object put(String key, Object value) {
        ...
        if (key.equals(FONT_KEY)) {
            ...
            previousValue = showHighlight;
            showHighlight = (Boolean)value;
            ...
            previousValue = showBranchControls;
            showBranchControls = (Boolean)value;
            ...
            previousValue = branchControlsColor;
            branchControlsColor = (Color)value;
            ...
            previousValue = branchControlsDisabledColor;
            branchControlsDisabledColor = (Color)value;
            ...
            previousValue = branchControlsSelectionColor;
            branchControlsSelectionColor = (Color)value;
            ...
            previousValue = branchControlsInactiveSelectionColor;
            branchControlsInactiveSelectionColor = (Color)value;
            ...
            previousValue = showGridLines;
            showGridLines = (Boolean)value;
    ...
    public Object remove(String key) {
        ...
        if (key.equals(FONT_KEY)) {
            ...
            previousValue = put(key, DEFAULT_INDENT);
        } else if (key.equals(SHOW_HIGHLIGHT_KEY)) {
            previousValue = put(key, DEFAULT_SHOW_HIGHLIGHT);
        } else if (key.equals(SHOW_BRANCH_CONTROLS_KEY)) {
            previousValue = put(key, DEFAULT_SHOW_BRANCH_CONTROLS);
        } else if (key.equals(BRANCH_CONTROLS_COLOR_KEY)) {
            previousValue = put(key, DEFAULT_BRANCH_CONTROLS_COLOR);
        } else if (key.equals(BRANCH_CONTROLS_DISABLED_COLOR_KEY)) {
            previousValue = put(key, DEFAULT_BRANCH_CONTROLS_DISABLED_COLOR);
        } else if (key.equals(BRANCH_CONTROLS_SELECTION_COLOR_KEY)) {
            previousValue = put(key, DEFAULT_BRANCH_CONTROLS_SELECTION_COLOR);
        } else if (key.equals(BRANCH_CONTROLS_INACTIVE_SELECTION_COLOR_KEY)) {
            previousValue = put(key, DEFAULT_BRANCH_CONTROLS_INACTIVE_SELECTION_COLOR);
        } else if (key.equals(GRID_COLOR_KEY)) {
            previousValue = put(key, DEFAULT_GRID_COLOR);
        } else if (key.equals(SHOW_GRID_LINES_KEY)) {
            previousValue = put(key, DEFAULT_SHOW_GRID_LINES);
        } else {
    ...
    public boolean containsKey(String key) {
        ...
        return (key.equals(FONT_KEY)
            ...
            || key.equals(INDENT_KEY)
            || key.equals(SHOW_HIGHLIGHT_KEY)
            || key.equals(SHOW_BRANCH_CONTROLS_KEY)
            || key.equals(BRANCH_CONTROLS_COLOR_KEY)
            || key.equals(BRANCH_CONTROLS_DISABLED_COLOR_KEY)
            || key.equals(BRANCH_CONTROLS_SELECTION_COLOR_KEY)
            || key.equals(BRANCH_CONTROLS_INACTIVE_SELECTION_COLOR_KEY)
            || key.equals(GRID_COLOR_KEY)
            || key.equals(SHOW_GRID_LINES_KEY)
